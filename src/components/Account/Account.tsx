        ...
        <>
            <div className="account-container">
                ...
                <div className='information-container'>
                    ...
                    >
                        <ColumnsDirective>
                            <ColumnDirective field='campaignname' headerText='Campaign Name' width='150' editType='dropdownedit' foreignKeyValue='name' foreignKeyField='id' edit={dropdownParams(campaigns)} />
                            <ColumnDirective field='accountname' headerText='Account Name' width='150' editType='dropdownedit' foreignKeyValue='name' foreignKeyField='id' edit={dropdownParams(contacts)} />
                            <ColumnDirective field='category' headerText='Category' width='150' editType='dropdownedit' foreignKeyValue='name' foreignKeyField='id' edit={dropdownParams(categories)} />
